...
// use Symfony\Component\RateLimiter\RateLimiterFactory; // Temporairement désactivé - package non installé
// use Symfony\Component\HttpKernel\Exception\TooManyRequestsHttpException; // Temporairement désactivé
...
class RegistrationController extends AbstractController
{
    ...
    {
        // Rate limiting temporairement désactivé - le package symfony/rate-limiter n'est pas installé
